...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        auto* Status = new tsl::elm::CustomDrawer([this](tsl::gfx::Renderer *renderer, u16 x, u16 y, u16 w, u16 h) {
            ...
            renderer->drawString("电池状态", false, LABEL_X, 120 + Y_OFFSET, 20, LABEL_COLOR_1);
            ...
            // Designed Capacity
            renderer->drawString("设计容量", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            renderer->drawString(designedCapacity_c, false, VALUE_X, currentY, FONT_SIZE, VALUE_COLOR);
            currentY += LINE_HEIGHT;
            
            // Temperature
            renderer->drawString("温度", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            renderer->drawString(batteryTemp_c, false, VALUE_X, currentY, FONT_SIZE, VALUE_COLOR);
            currentY += LINE_HEIGHT;
            
            // Raw Charge
            renderer->drawString("原始电量", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            renderer->drawString(rawCharge_c, false, VALUE_X, currentY, FONT_SIZE, VALUE_COLOR);
            currentY += LINE_HEIGHT;
            
            // Age
            renderer->drawString("电池寿命", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            renderer->drawString(batteryAge_c, false, VALUE_X, currentY, FONT_SIZE, VALUE_COLOR);
            currentY += LINE_HEIGHT;
            
            // Voltage
            renderer->drawString("电压", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            renderer->drawString(voltageAvg_c, false, VALUE_X, currentY, FONT_SIZE, VALUE_COLOR);
            currentY += LINE_HEIGHT;
            
            // Current Flow
            renderer->drawString("电流", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            renderer->drawString(currentFlow_c, false, VALUE_X, currentY, FONT_SIZE, VALUE_COLOR);
            currentY += LINE_HEIGHT;
            
            // Power Flow
            renderer->drawString("功率", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            renderer->drawString(powerFlow_c, false, VALUE_X, currentY, FONT_SIZE, VALUE_COLOR);
            currentY += LINE_HEIGHT;
            
            // Remaining Time
            renderer->drawString("剩余时间", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            ...
            if (isChargerConnected) {
                ...
                renderer->drawString("充电器状态", false, LABEL_X, currentY, 20, LABEL_COLOR_1);
                currentY += 2*LINE_HEIGHT;
                // Input Current Limit
                renderer->drawString("输入电流限制", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
                ...
                // Charger Type
                renderer->drawString("充电器类型", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
                ...
                // Charger Max Current
                renderer->drawString("最大电流", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
    ...
    virtual void update() override {
        ...
        if (isChargerConnected) {
            ...
            const char* chargerTypeName = "未知";
            switch (ChargerConnected) {
                case BatteryChargeInfoFieldsChargerType::None: chargerTypeName = "无"; break;
                case BatteryChargeInfoFieldsChargerType::PD: chargerTypeName = "PD充电器"; break;
                case BatteryChargeInfoFieldsChargerType::TypeC_1500mA: chargerTypeName = "Type-C 1.5A"; break;
                case BatteryChargeInfoFieldsChargerType::TypeC_3000mA: chargerTypeName = "Type-C 3A"; break;
                case BatteryChargeInfoFieldsChargerType::DCP: chargerTypeName = "专用充电端口(DCP)"; break;
                case BatteryChargeInfoFieldsChargerType::CDP: chargerTypeName = "带数据传输充电端口(CDP)"; break;
                case BatteryChargeInfoFieldsChargerType::SDP: chargerTypeName = "标准数据端口(SDP)"; break;
                case BatteryChargeInfoFieldsChargerType::Apple_500mA: chargerTypeName = "Apple 0.5A"; break;
                case BatteryChargeInfoFieldsChargerType::Apple_1000mA: chargerTypeName = "Apple 1A"; break;
                case BatteryChargeInfoFieldsChargerType::Apple_2000mA: chargerTypeName = "Apple 2A"; break;
                default: chargerTypeName = "未知"; break;
            }
            snprintf(chargerType_c, sizeof(chargerType_c), "%s", chargerTypeName);
