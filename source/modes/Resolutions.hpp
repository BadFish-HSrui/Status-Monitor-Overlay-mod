    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        auto* Status = new tsl::elm::CustomDrawer([this](tsl::gfx::Renderer *renderer, u16 x, u16 y, u16 w, u16 h) {
            ...
            if (gameStart && NxFps && NxFps->API >= 1 && (Resolutions_c[0] != '\0' && Resolutions2_c[0] != '\0')) {
                ...
                int xOffset = 10;
                int yOffset = 10;
                renderer->drawString("纹理:", false, xOffset+final_base_x + 20, yOffset+final_base_y + 20, 20, (settings.catColor));
                renderer->drawString(Resolutions_c, false, xOffset+final_base_x + 20, yOffset+final_base_y + 55, 18, (settings.textColor));
                renderer->drawString("窗口:", false, xOffset+final_base_x + 180, yOffset+final_base_y + 20, 20, (settings.catColor));
            ...
            // When game is not using NVN or is incompatible
                ...
                const std::string msg = "游戏未运行或不兼容。";
