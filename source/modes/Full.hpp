    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        auto Status = new tsl::elm::CustomDrawer([this](tsl::gfx::Renderer *renderer, u16 x, u16 y, u16 w, u16 h) {
            ...
            if (R_SUCCEEDED(clkrstCheck) || R_SUCCEEDED(pcvCheck)) {
                ...
                renderer->drawString("CPU 使用率", false, COMMON_MARGIN, 120, 20, (0xFFFF));
            ...
            if (R_SUCCEEDED(clkrstCheck) || R_SUCCEEDED(pcvCheck) || R_SUCCEEDED(nvCheck)) {
                ...
                renderer->drawString("GPU 使用率", false, COMMON_MARGIN, 285, 20, (0xFFFF));
                if (R_SUCCEEDED(clkrstCheck) || R_SUCCEEDED(pcvCheck)) {
                    if (settings.showTargetFreqs) { 
            ...
            if (R_SUCCEEDED(clkrstCheck) || R_SUCCEEDED(pcvCheck) || R_SUCCEEDED(Hinted)) {
                ...
                renderer->drawString("内存 使用率", false, COMMON_MARGIN, 375, 20, (0xFFFF));
                if (R_SUCCEEDED(clkrstCheck) || R_SUCCEEDED(pcvCheck)) {
                    if (settings.showTargetFreqs) {
                ...
                if (R_SUCCEEDED(Hinted)) {
                    ...
                    renderer->drawString("总计: \n应用: \n小程序: \n系统: \n系统保留: ", false, COMMON_MARGIN, height_offset + 40, 15, (0xFFFF));
            ...
            if (R_SUCCEEDED(i2cCheck) || R_SUCCEEDED(tcCheck) || R_SUCCEEDED(pwmCheck)) {
                renderer->drawString("主板", false, 20, 550, 20, (0xFFFF));
                ...
                if (R_SUCCEEDED(i2cCheck) || R_SUCCEEDED(tcCheck)) {
                    ...
                    renderer->drawString("温度:", false, COMMON_MARGIN, 590, 15, (0xFFFF));
                    renderer->drawString("核心\n主板\n壳温", false, COMMON_MARGIN + textWidth1, 590, 15, (0xFFFF));
            ...
            if (GameRunning) {
                ...
                if (settings.showFPS || settings.showRES || settings.showRDSD) {
                    renderer->drawString("游戏", false, COMMON_MARGIN + width_offset, 185+12, 20, (0xFFFF));
                }
