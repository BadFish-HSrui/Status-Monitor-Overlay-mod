        ...
        auto Status = new tsl::elm::CustomDrawer([this](tsl::gfx::Renderer *renderer, u16 x, u16 y, u16 w, u16 h) {
            ...
            if (R_SUCCEEDED(i2cCheck) || R_SUCCEEDED(tcCheck) || R_SUCCEEDED(pwmCheck)) {
                ...
                if (R_SUCCEEDED(i2cCheck) || R_SUCCEEDED(tcCheck)) {
                    static auto dimensions1 = renderer->drawString("温度: ", false, 0, 590, 15, renderer->a(0x0000));
                    static auto dimensions2 = renderer->drawString("核心 \n主板 \n壳温 ", false, 0, 590, 15, renderer->a(0x0000));
                    renderer->drawString("温度:", false, COMMON_MARGIN, 590, 15, renderer->a(0xFFFF));
                    renderer->drawString("核心\n主板\n壳温", false, COMMON_MARGIN + dimensions1.first, 590, 15, renderer->a(0xFFFF));
