...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        tsl::elm::OverlayFrame* rootFrame = new tsl::elm::OverlayFrame("性能监控", "透明度");
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        if (isFPSGraphMode) {
            ...
            auto* showInfo = new tsl::elm::ToggleListItem("信息", getCurrentShowInfo());
...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        for (size_t i = 0; i < elementOrder.size(); i++) {
            ...
            elementItem->setValue(isEnabled ? "开" : "关", !isEnabled ? true : false);
